...
<div class="relative isolate px-6 pt-14 lg:px-8">
	...
	>
		<div
			class="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#80fff7] to-[#115ce7] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
			style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"
		></div>
	</div>

	<div class=" pt-24 text-center sm:pt-24">
		<div class="mx-auto max-w-7xl px-6 lg:px-8">
			...
			<p class="mt-6 text-center text-lg leading-8 text-gray-600">
				Our range of IoT and AI-driven solutions are designed to transform industries, enhance
				security, and drive efficiency. Explore how our technology can help you achieve your goals.
			</p>
				...
				<Card padding="none" size="xl" class="grid md:grid-cols-2">
					...
					>
						...
						>
							...
							<h3 class="text-lg font-semibold text-gray-900 dark:text-white">Sannarah</h3>
							<p class="my-4 font-light">
								Sannarah is an IoT camera designed for highway surveillance, equipped with advanced
								license plate recognition technology. Perfect for law enforcement, traffic
								monitoring, and transportation agencies.
							</p>
						</blockquote>
					</figure>
					<figure
					...
					>
						...
						>
							...
							<p class="my-4 font-light">
								...
								accurate vehicle identification and data management.
							</p>
						</blockquote>
					</figure>
					<figure
	...
	<div class="relative isolate px-6 pt-14 lg:px-8">
		...
		<div class=" pb-6 text-center sm:pb-6">
			<div class="mx-auto max-w-7xl px-6 lg:px-8">
				<h2 class="text-center text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
					Our Custom Services
				</h2>
			...
			<div class="mx-auto max-w-2xl py-12 sm:py-12 lg:py-12">
				<Card padding="none" size="xl" class="grid md:grid-cols-2">
					...
					>
						...
						>
							<svg
								class="mb-4 h-12 w-12 text-sky-600"
								aria-hidden="true"
								xmlns="http://www.w3.org/2000/svg"
								width="24"
								height="24"
							...
							<h3 class="text-lg font-semibold text-gray-900 dark:text-white">IoT Development</h3>
							<p class="my-4 font-light">
								Providing end-to-end IoT solutions, from hardware design to software integration, to
								ensure seamless device connectivity and data flow.
							</p>
						</blockquote>
					</figure>
					<figure
					...
					>
						...
						>
							...
							<p class="my-4 font-light">
								Developing custom Object Detection (OD) and Optical Character Recognition (OCR)
					...
					>
						...
						>
							...
							<p class="my-4 font-light">
								Designing and managing scalable cloud infrastructure to optimize performance,
					...
					>
						...
						>
							...
							<h3 class="text-lg font-semibold text-gray-900 dark:text-white">Data Services</h3>
							<p class="my-4 font-light">
								Offering comprehensive data management services, including data analysis, storage
								solutions, and big data processing.
							</p>
						</blockquote>
					</figure>
					<figure
					...
					>
						...
						>
							...
							<p class="my-4 font-light">
								Building robust, scalable, and customized web and mobile applications to meet
								diverse business needs across various industries.
							</p>
						</blockquote>
					</figure>
					<figure
					...
					>
						...
						>
							...
							<h3 class="text-lg font-semibold text-gray-900 dark:text-white">I.T. Consulting</h3>
							<p class="my-4 font-light">
								Providing expert IT consulting services to help businesses navigate technology
								challenges and optimize their IT infrastructure.
							</p>
						</blockquote>
					</figure>
				</Card>
